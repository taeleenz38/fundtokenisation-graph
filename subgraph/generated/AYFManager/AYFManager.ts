...
export class AYFManager__depositIdToDepositorResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
...
export class AYFManager__redemptionIdToRedeemerResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class AYFManager extends ethereum.SmartContract {
  static bind(address: Address): AYFManager {
    return new AYFManager("AYFManager", address);
  }
  ...
  depositIdToDepositor(param0: Bytes): AYFManager__depositIdToDepositorResult {
    let result = super.call(
    ...
    return new AYFManager__depositIdToDepositorResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_depositIdToDepositor(
    param0: Bytes,
  ): ethereum.CallResult<AYFManager__depositIdToDepositorResult> {
    let result = super.tryCall(
      "depositIdToDepositor",
      "depositIdToDepositor(bytes32):(address,uint256,uint256)",
      [ethereum.Value.fromFixedBytes(param0)],
    ...
    return ethereum.CallResult.fromValue(
      new AYFManager__depositIdToDepositorResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  redemptionIdToRedeemer(
    param0: Bytes,
  ): AYFManager__redemptionIdToRedeemerResult {
    let result = super.call(
      "redemptionIdToRedeemer",
    ...
    return new AYFManager__redemptionIdToRedeemerResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean(),
  ...
  try_redemptionIdToRedeemer(
    param0: Bytes,
  ): ethereum.CallResult<AYFManager__redemptionIdToRedeemerResult> {
    let result = super.tryCall(
      "redemptionIdToRedeemer",
      "redemptionIdToRedeemer(bytes32):(address,uint256,uint256,bool)",
      [ethereum.Value.fromFixedBytes(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new AYFManager__redemptionIdToRedeemerResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean(),
