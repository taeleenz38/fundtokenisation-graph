...
export class SanctionBalanceBurn extends ethereum.Event {
  get params(): SanctionBalanceBurn__Params {
    return new SanctionBalanceBurn__Params(this);
  }
}

export class SanctionBalanceBurn__Params {
  _event: SanctionBalanceBurn;

  constructor(event: SanctionBalanceBurn) {
    this._event = event;
  }
